 ...
 * Allows 20 requests per minute per IP address on /api/** endpoints.
 */
@Component
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        RateWindow window = clientWindows.compute(clientIp, (key, existing) -> {
        ...
        if (window.count.get() > MAX_REQUESTS_PER_MINUTE) {
            ...
            response.getWriter().write(
                    "{\"status\":\"TOO_MANY_REQUESTS\",\"message\":\"Rate limit exceeded. Try again in a minute.\"}"
            );
            return;
        }
